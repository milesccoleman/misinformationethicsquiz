...
function showScores() {
    ...
    gameOverHTML += "<h2 id='score'> Your score: " + quiz.score + "/5" + "</h2>" + "<a href='https://www.milesccoleman.com/misinformationethicsquiz/'>Restart Quiz</a>";
