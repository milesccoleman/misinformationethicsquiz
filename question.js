...
var questions = [
    ...
    new Question("The number of COVID-19 deaths recorded so far in 2021 has surpassed the total for 2020.", ["It's true", "It's misinformation"], "It's true", "Both Johns Hopkins Coronavirus Resource Center data and CDC mortality death certificate data indicate there were more deaths in 2021 than in 2020.<p style='color: blue'>Although this claim is one that is easily verifiable, it nonetheless runs the risk of being automatically removed on a platform like YouTube, which uses automation and strict definitions of non-misinformation to unilaterally unpublish content.</p><a target='_blank' href='https://www.politifact.com/factchecks/2022/jan/18/roger-williams/williams-accurate-there-were-more-covid-19-deaths-/'>Read more</a>"),    
